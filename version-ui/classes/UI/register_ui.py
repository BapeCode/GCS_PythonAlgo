...
class Ui_RegisterWindow(object):
    def setupUi(self, Register):
        ...
        Register.resize(650, 650)
        Register.setStyleSheet(u"QMainWindow {\n"
...
"")
    ...
    def retranslateUi(self, Register):
        ...
        self.label_9.setText(QCoreApplication.translate("Register", u"Username", None))
        self.usernameButton.setText("")
        self.usernameButton.setPlaceholderText(QCoreApplication.translate("Register", u"Your username", None))
        self.label_10.setText(QCoreApplication.translate("Register", u"Password", None))
        self.passwordButton.setPlaceholderText(QCoreApplication.translate("Register", u"Your password", None))
        self.succes.setText(QCoreApplication.translate("Register", u"Identifier alwready exist", None))
        self.pushButton_3.setText(QCoreApplication.translate("Register", u"Register", None))
    # retranslateUi
